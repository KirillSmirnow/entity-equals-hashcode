...
public class EntityComparator {
    ...
    public static void assertEqual(Object entity1, Object entity2) {
        assertThat(entity1).isNotSameAs(entity2); // comparing not same objects is of greater interest
    ...
    public static void assertNotEqual(Object entity1, Object entity2) {
        ...
        assertThat(entity1).doesNotHaveSameHashCodeAs(entity2); // desired, not mandatory!
